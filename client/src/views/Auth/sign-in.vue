<template>
    <div class="sign-in auth-form">
        <n-card title="Sign in" class="sign-in__card">
            <n-form ref="formRef" :model="signInData" :rules="rules">
                ...
                <n-form-item label="Password" path="password">
                    <n-input v-model:value="signInData.password" class="card__password" type="password"
            ...
            <template #footer>
                <div class="sign-in__footer">
                    <span>
                        ...
                        <router-link class="sign-in__signup-link" :to="{ name: 'SignUp' }">
                            Signup
                        </router-link>
                    </span>
                </div>
